...
struct WorldMap: View {
    ...
    //This is a derived value passed as a paramater
    //So, @ObservedObject
    @ObservedObject var store: LocationStore
    
    // Centre on LCS, wide enough to show most of eastern North America
    @State var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 44.43922, longitude: -78.43922), span: MKCoordinateSpan(latitudeDelta: 40, longitudeDelta: 40))
